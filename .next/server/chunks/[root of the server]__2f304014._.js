...
"[project]/.next-internal/server/app/api/posts/[id]/like/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                ...
                try {
                    ...
                    const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["User"].findOne({
    ...
    callbacks: {
        ...
        async signIn ({ user, account, profile }) {
            if (account.provider === "google") {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
                const existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["User"].findOne({
                    googleId: profile.sub
                });
                if (!existingUser) {
                    const newUsername = profile.name?.replace(/\s+/g, "").toLowerCase() || profile.email.split("@")[0];
                    const newUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["User"].create({
...
async function POST(request, { params }) {
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$next$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServerSession"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$auth$2f5b2e2e2e$nextauth$5d2f$route$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authOptions"]);
    ...
    const post = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Post"].findById(id);
    ...
    const updatedPost = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Post"].findByIdAndUpdate(id, {
        $inc: {
            likes: 1
        },
        $push: {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__2f304014._.js.map